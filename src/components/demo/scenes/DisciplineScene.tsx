    ...
    <div className="w-full max-w-4xl space-y-12">
      <div className="flex flex-col md:flex-row justify-between items-end gap-6">
        ...
        <div className="flex gap-4">
           ...
           <div className="h-14 w-48 bg-blue-600 rounded-2xl flex items-center justify-center text-white font-black uppercase text-xs tracking-widest shadow-xl shadow-blue-900">
              LOG INCIDENT
           </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <motion.div
          ...
          className="bg-white rounded-[2.5rem] p-8 shadow-2xl space-y-6"
        >
          <h4 className="text-sm font-black text-slate-900 uppercase tracking-widest border-b border-slate-50 pb-4">Recent Commendations</h4>
          {[
            ...
            <div key={item.name} className="flex justify-between items-center p-4 bg-slate-50 rounded-2xl border border-slate-100">
              <div className="flex items-center gap-3">
                 ...
                 <div>
                    ...
                    <p className="text-[10px] font-medium text-slate-400">{item.reason}</p>
                 </div>
              </div>
        ...
        <motion.div
          ...
          className="bg-slate-900 rounded-[2.5rem] p-8 border border-slate-800 space-y-6"
        >
          <h4 className="text-sm font-black text-slate-400 uppercase tracking-widest border-b border-slate-800 pb-4">Incident Log</h4>
          {[
            ...
            <div key={item.name} className="flex justify-between items-center p-4 bg-white/5 rounded-2xl border border-white/5">
              <div className="flex items-center gap-3">
